...
const renderHTML = (HbScriptId, renderTagId, dataObj) => {
    const templateElement = document.getElementById(HbScriptId);
    const templateSource = templateElement.innerHTML;
    const template = Handlebars.compile(templateSource);
    const compiledHtml = template(dataObj);
    document.getElementById(renderTagId).innerHTML = compiledHtml;
}

renderHTML('templateHB', 'information', context);